...
pdf: tmp
	cd ${TMPDIR} && TEXINPUTS=./sty//:$$TEXINPUTS BSTINPUTS=./sty//:$$BSTINPUTS ${PDFLATEX} ${MAINFILE}
	cd ${TMPDIR} && TEXINPUTS=./sty//:$$TEXINPUTS BSTINPUTS=./sty//:$$BSTINPUTS ${BIBTEX} ${FILENAME}
	cd ${TMPDIR} && TEXINPUTS=./sty//:$$TEXINPUTS BSTINPUTS=./sty//:$$BSTINPUTS ${PDFLATEX}  ${FILENAME}
	cd ${TMPDIR} && TEXINPUTS=./sty//:$$TEXINPUTS BSTINPUTS=./sty//:$$BSTINPUTS ${PDFLATEX}  ${FILENAME}
