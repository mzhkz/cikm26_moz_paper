...
GSEs are retrieval-and-generation systems that retrieve information from the web and generate synthesized answers with user intent and background using large language models (LLMs)~\cite{geo-apmr+24}.
% the core of 
