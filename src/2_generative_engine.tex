...
Pranjal et al.\ formalize GSEs and provide a system model~\cite{geo-apmr+24}.
...
In contrast, while GSEs similarly use the web as an external database, the nature of this database differs from that of \emph{RAG systems}.
...
Therefore, unlike \emph{RAG systems}, GSEs use search engines (SE) for retrieval from the external database (web).
In our study, we focus on the differences in external database characteristics between GSEs and \emph{RAG systems}.
