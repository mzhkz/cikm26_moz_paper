...
A core technology of GSEs is Retrieval-Augmented Generation (RAG), which retrieves relevant content to user query from outside of LLMs and incorporates it into LLM inference~\cite{internet-augmented-language-models-fewshot-arxiv22, internet-augmented-dialogue-generation-arxiv21, rag-kdd24}.
...
Our study distinguishes GSEs and Rag system based on the diferences in external database characteristics.
