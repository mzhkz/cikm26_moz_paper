...
This method, in which attackers place a large amount of content that ``looks like legitimate media'' on the web, makes approaches that evaluate only the content itself ineffective.
...
Our framework introduces new evaluation criteria centered on the publisher attributes of citations in generated answers, enabling a systematic assessment of how robust GSEs are to poisoning attacks.

Specifically, our framework addresses the following questions: 
(1) Which publishers' content do GSEs preferentially cite, and does this reveal any bias in citation selection from the perspective of publishers? 
(2) Which publishers' content has the power to influence the faithfulness and accuracy of the generated answers?
(3) How does personalization impact citation behavior in GSEs?

Our primary focus is on establishing robust evaluation criteria for assessing the vulnerability of GSEs to poisoning attacks.
We do not aim to demonstrate practical attacks or identify actual instances of malicious content injection.
Rather, our goal is to assess the potential risk of poisoning attacks to reveal the underlying attack surfaces, and to clarify the degree of resilience that GSEs exhibit against such attacks.

In this study, we apply our framework to the political domain.
In a society where GSEs serve as a primary means of accessing information, we aim to reveal, through the citation behavior of GSEs, the risks related to the delivery of political information, which is essential to democratic processes.
In particular, we focus on the task in which voters gather information about specific political parties, and we identify the attack surface through our framework by political party, by ideology, by country, and by differences in voter profiles (such as prior political knowledge and ideology).
Based on this attack surface, we discuss in which areas attackers could potentially distort political information and cause bias or distortion in the delivery of information.
