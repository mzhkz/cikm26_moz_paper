...
Personalization is a key factor in improving the user experience of chat-based applications such as ChatGPT~\cite{openai2024memory}, Claude~\cite{anthropic2025memory}, and Gemini~\cite{google2026personal}, and is a recognized direction in prior studies on language models~\cite{salemi2024lamp, mysore2024pearl}.
...
\begin{description}
  ...
  \item[\textbf{\textit{R-2}}] Which publishers' content has the power to influence the faithfulness and domination of generated answers?
