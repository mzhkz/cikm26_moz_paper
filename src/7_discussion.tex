...
Still, our results show that GSE citation tendencies vary across user profiles even within the political domain.
Moreover, our framework are domain-agnostic, and to the best of our knowledge, ours is the first to analyze GSE citation patterns from the perspectives of content-injection barriers and user profiles.
...
Third, our citation coverage analysis relies on Sentence-BERT, whose multilingual embedding quality may vary across languages; therefore, we do not compare ground scores across countries.
For within-country comparisons, in the Japanese case, questions yielded $86\%$ Japanese and $14\%$ English citations, and in the English case, questions yielded $100\%$ English citations; since each within-country comparison is dominated by a single language, this limitation does not affect our primary findings.
